...
//                pipeline.addLast("ssl", sslContext.newHandler(channel.alloc())); // SSL/TLS handler
                ...
                pipeline.addLast("aggregator", new HttpObjectAggregator(1024 * 1024)); // 1MB max message size
